...
# Keep ranges identical to original script
RANGES = {
...
def main():
    parser = argparse.ArgumentParser(
        description="FilmNet-only point-map exporter from STL"
    )
    parser.add_argument("--stl", type=str, required=True, help="Path to input STL file")
    ...
    print(f" - Summed force CSV: {sum_point_csv}")
